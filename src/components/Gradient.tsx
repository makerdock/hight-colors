...
const GradientCanvas: React.FC<GradientProps> = ({ colors }) => {
    ...
    return <div className={classNames(
        'relative md:h-[400px] md:w-[400px] w-[100dvw] h-[100dvh] transition-all duration-300 ease-in-out mx-auto',
        scriptLoaded ? "" : 'blur-lg opacity-0'
    )}>
        <canvas ref={canvasRef} id="my-canvas-id" className="w-full h-full absolute z-0"></canvas>
        <svg className=' z-30 absolute h-full w-full' width="400" height="400" viewBox="0 0 2500 2500" fill="white" xmlns="http://www.w3.org/2000/svg">
            <path
